...
11. Objetivos e indicadores (metas, resultados, dashboards) — **sí va en Ágora** (confirmado por el usuario, 2026-09-07): cada responsable de área ve y actualiza el resultado de sus propios objetivos. ✅ Completo (2026-09-07).
...
14. Dashboard Ejecutivo (KPIs, gráficos, vencimientos, tendencias, eficacia, reincidencias) — **sí va en Ágora** (confirmado por el usuario, 2026-09-07): panel de transparencia visible para toda la empresa. ✅ Completo (2026-09-07) — implementado dentro del Home (`app/page.tsx`), no como pantalla propia. **Roadmap real de Ágora completo: Fases 1–8, 11 y 14.**
